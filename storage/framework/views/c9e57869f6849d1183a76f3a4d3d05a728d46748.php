...
experience to be truly fulfilling. Laravel attempts to take the pain out of development by easing common tasks used in the majority of web projects, such as</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-sm-6 col-xs-12">
          <p class="copyright-text">Copyrights &copy;2021 sms website &nbsp; All Rights Reserved</p>
        </div>
      </div>
    </div>
    <!-- END Bottom section -->
  ...
  <script src="<?php echo e(asset('assets/js/snackbar.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/mmenu.min.js')); ?>"></script>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\smsApp\resources\views/includes/footer.blade.php ENDPATH**/ ?>